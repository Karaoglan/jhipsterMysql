...
public class JhipsterMysqlApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterMysqlApp.class);

    private final Environment env;

    public JhipsterMysqlApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterMysql.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterMysqlApp.class);
